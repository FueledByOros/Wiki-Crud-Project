...
urlpatterns = [
    ...
    # API endpoints
    path('api/articles/<int:article_id>/', views.api_article, name='api_article'),
    ...
    path('api/articles/<int:article_id>/edit/', views.api_update_article, name='api_update_article'),
